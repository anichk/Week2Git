...
add_action( 'wp_enqueue_scripts', 'flat_sky_enqueue_styles', 'flat_sky_enqueue_scripts' );
function flat_sky_enqueue_scripts() {
	wp_enqueue_script('calcAnswer', get_template_directory_uri() . '/js/calcKMA.js');	
}
